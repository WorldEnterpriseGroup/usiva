...
In order to provide evidence of the enterprise's profitability for an E-2 Treaty Investor Visa, the following documents should be submitted: 

- [ ] 1. Financial statements for the past three years, including balance sheets, income statements, and cash flow statements. 

- [ ] 2. Tax returns for the past three years. 

- [ ] 3. Evidence of the enterprise's current financial position, such as current bank statements and accounts receivable/payable reports. 

- [ ] 4. Evidence of the enterprise's current profitability, such as current income statements and cash flow statements. 

- [ ] 5. Evidence of the enterprise's future profitability, such as a business plan, market analysis, and/or projections of future income and expenses. 

- [ ] 6. Evidence of the enterprise's ability to generate sufficient income to support the investor, such as proof of the investor's salary and/or dividends.
