...
export const editorialBoundary =
  'USIVA is not a law firm. These briefs are informational planning content, not legal advice, and they do not guarantee admission, a visa, a status, employment authorization, an immigration benefit, or a government decision. Verify current requirements with the relevant official agency, school, sponsor, employer, or qualified immigration attorney before acting.';
...
export const briefSources: readonly BriefSource[] = [
  ...
  },
  {
    ...
    why: 'Centralized USCIS policy source for benefit-adjudication guidance; it is not a substitute for a case-specific legal analysis.',
    lastChecked: briefsLastChecked,
  },
  {
  ...
  },
  {
    ...
    why: 'Dynamic USCIS tool for a current processing-time estimate; it is not a promise about an individual case.',
    lastChecked: briefsLastChecked,
  },
  {
    id: 'cbp-inspection',
...
export const immigrationBriefs: readonly ImmigrationBrief[] = [
  {
    ...
    deck: 'A visa category should follow the real purpose and activities of a trip, not a job title, a hopeful outcome, or a form someone mentioned in passing.',
    ...
    takeaway: 'Write down what you will do, who directs it, who pays, where it happens, how long it lasts, and whether any part looks like study, training, or work before choosing a category to investigate.',
    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          { label: 'One sentence', text: 'State the primary reason for travel without using a visa class as a substitute for the description.' },
          ...
          { label: 'Duration and exit', text: 'Record the planned dates, locations, and what happens at the end of the visit or program; do not turn a general intention into a guarantee.' },
      ...
      {
        id: 'category-lenses',
        heading: 'Use category pages as lenses, not as a self-issued answer',
        table: {
      ...
      },
      {
        ...
        heading: 'A visa is not the same thing as admission',
        paragraphs: [
          paragraph('A visa is a travel document and category decision handled through the State Department’s visa process. At the port of entry, CBP conducts inspection and determines whether an arriving applicant is admissible under the facts and law applicable at that time. The State Department and CBP pages should therefore be read together when the question is travel, not treated as interchangeable approval screens.', ['state-us-visas', 'cbp-admission']),
          paragraph('Keep the distinction visible in your record: visa category, visa validity, admission inspection, admission record, and the activity you intend to perform are related but separate questions. A category page cannot answer every question about a particular person’s history or itinerary.', ['cbp-admission']),
        ],
      ...
      },
      {
        ...
        bullets: [
          ...
          'A school, sponsor, employer, or consular post gives instructions that do not match a general web summary.',
          'The proposed activity depends on prior immigration history, a previous refusal, a change of status, or a personal deadline.',
        ],
        paragraphs: [
          paragraph('The right next action is not to pick the least restrictive-sounding category. Preserve the complete activity description and ask the authority responsible for the program, admission, visa, status, or employment question to verify the classification.', ['state-visa-categories', 'cbp-admission']),
        ],
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          paragraph('The words temporary and permanent describe the route objective, not a promise about how a person feels about the future. A reader should document the actual purpose, the category-specific requirements, and the relevant agency’s current instructions rather than infer a route from a hoped-for long-term outcome.', ['state-visa-categories']),
        ],
      ...
      },
      {
        ...
        note: 'This is an orientation map, not a universal sequence. Some routes skip, combine, or add steps; the location and category determine which agency has authority at each point.',
        sourceIds: ['state-immigrate', 'uscis-green-card-process', 'state-nvc', 'cbp-admission'],
      },
      {
        id: 'approval-is-not-admission',
        heading: 'Approval at one desk is not completion at every desk',
        paragraphs: [
  ...
  },
  {
    ...
    deck: 'The immigration system is easier to read when each agency’s decision is named separately: benefit or petition, visa processing, and inspection/admission are not interchangeable.',
    ...
    sections: [
      {
        ...
        paragraphs: [
          paragraph('USCIS, the Department of State, and CBP all sit inside a larger federal system, but they do not answer the same question. USCIS handles immigration benefit and naturalization services and related adjudications. The State Department handles visa information and consular processing. CBP inspects people seeking admission at ports of entry and makes the admission decision under its authority.', ['uscis-about', 'state-us-visas', 'cbp-inspection', 'cbp-admission']),
          paragraph('The practical result is that a person may have a USCIS notice, a State Department visa record, and a CBP admission record at different moments. One record can inform the next handoff without replacing it.', ['state-nvc', 'cbp-i94']),
        ],
      ...
      },
      {
        ...
        table: {
          ...
          headers: ['Agency or desk', 'Questions it can help answer', 'What it does not replace'],
          rows: [
            ...
            ['National Visa Center', 'For applicable immigrant visa cases, what document and interview-processing step follows USCIS petition approval?', 'A general nonimmigrant case update or a guarantee that a visa will issue'],
      ...
      },
      {
        ...
        steps: [
          ...
          { label: 'Question', text: 'Ask one concrete question of the agency or institution that controls the next step; do not send a broad request to every desk.' },
      ...
      },
      {
        ...
        paragraphs: [
          paragraph('USIVA can help a reader organize the question and find the public starting point. It cannot transfer authority from USCIS, the State Department, CBP, a school, a sponsor, an employer, or a qualified attorney. Verify current requirements with the responsible official source before filing, traveling, working, or relying on a deadline.', ['uscis-about', 'state-us-visas', 'cbp-admission']),
        ],
        note: 'USIVA is not a law firm. If personal facts could change eligibility or consequences, stop at orientation and obtain individualized advice from the appropriate professional or agency.',
        sourceIds: ['uscis-about', 'state-us-visas', 'cbp-admission'],
      },
    ],
  },
  {
    ...
    deck: 'A readiness file is useful when every important claim has a source, date, owner, and question attached to it—not when it is merely large.',
    ...
    takeaway: 'For each record, write: who issued it, when it was issued, when you checked it, what it supports, what it does not establish, and who owns the next answer.',
    ...
    sections: [
      {
        ...
        paragraphs: [
          paragraph('A passport can support identity and travel-document facts. An admission letter can support a school relationship. A financial record can support a source and date of funds. A role description can explain duties. None of those records, standing alone, answers every question about a person’s eligibility, status, authorization, admissibility, or future outcome.', ['state-student', 'cbp-admission', 'uscis-policy-manual']),
          paragraph('The USCIS Policy Manual and official State Department pages are useful for understanding the public framework, but a general framework is not a universal evidence list. The school, consular post, agency notice, employer process, or qualified attorney may require a different or more specific record for the facts at hand.', ['uscis-policy-manual', 'state-visa-categories']),
        ],
      ...
      },
      {
        ...
        table: {
          caption: 'Planning questions to organize; not a universal filing checklist',
        ...
        note: 'Index sensitive records without publishing them. A source trail should improve a secure handoff, not create a new exposure risk.',
      ...
      },
      {
        ...
        steps: [
          ...
          { label: 'Meaning', text: 'Write what the record supports and what it cannot establish. Mark an assumption as an assumption.' },
      ...
      },
      {
        ...
        bullets: [
          ...
          'Can the reviewer understand the packet without receiving unnecessary passport, financial, or immigration identifiers?',
        ],
        paragraphs: [
      ...
      },
      {
        ...
        note: 'Verify current evidence instructions with the relevant official agency before filing or submitting records. USIVA is not a law firm and cannot decide what a particular case requires.',
  ...
  },
  {
    ...
    deck: 'Form I-9 and E-Verify are employer-side verification processes. They should be coordinated with the worker’s actual immigration and work-authorization record, not used as a shortcut around it.',
    ...
    takeaway: 'A clean hiring file explains the role, the employee’s Form I-9 process, any E-Verify participation, and the source of the work-authorization information without asking the employer process to decide a visa classification.',
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          paragraph('The employee and employer each have a role in the Form I-9 process. Keep the verification record focused on identity and employment authorization as the official instructions describe it. Do not ask a worker to prove more than the current process requires, and do not substitute a public article for the employer’s authorized procedure.', ['i9-central']),
        ],
      ...
      },
      {
        ...
        table: {
          ...
          headers: ['Record or process', 'What it is for', 'What it does not decide'],
          rows: [
            ...
            ['E-Verify', 'An electronic employer process that compares Form I-9 information with available government records when the employer participates or is required to use it', 'A replacement for Form I-9 or a general credential that authorizes every future job'],
            ['Immigration/status record', 'The worker’s visa, admission/status record, employment authorization document, school/sponsor instruction, or other source that may define a work boundary', 'A guarantee that the employer’s verification process will resolve a personal eligibility question'],
          ],
        },
      ...
      },
      {
        ...
        steps: [
          ...
          { label: 'Documents', text: 'Follow the current acceptable-document and receipt rules. Do not invent a custom list or demand a particular document when the official process permits a choice.' },
      ...
      {
        id: 'worker-side',
        heading: 'For the worker, verification is not the whole authorization analysis',
        paragraphs: [
          paragraph('A completed Form I-9 or an E-Verify result does not, by itself, answer whether a proposed role fits the worker’s underlying immigration classification, school or sponsor rules, authorization period, or specific duties. Those questions may belong to USCIS, a DSO or sponsor, an employer representative, or qualified immigration counsel.', ['i9-central', 'everify-process', 'uscis-policy-manual']),
      ...
      },
      {
        ...
        bullets: [
          'A role description that matches the work the person will actually perform.',
          ...
          'A secure channel for any personal record; no passport scan or immigration identifier in an open email thread unless the authorized recipient requires it.',
        ],
        note: 'Verify current requirements with USCIS, E-Verify, the employer’s authorized representative, the school or sponsor, and qualified counsel where the facts require legal analysis. USIVA is not a law firm.',
  ...
  },
  {
    ...
    number: '06',
    label: 'Status desk',
    title: 'Case status is a handoff map, not an outcome forecast',
    deck: 'The safest status check begins with the agency named on the notice. Use the official portal for that record, preserve the confirmation, and do not convert a status line into a prediction.',
    ...
    takeaway: 'Never start with a search-engine snippet or a third-party tracker. Start with the official notice, agency, record number, and portal named by the agency.',
    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          ...
          { label: 'Capture', text: 'Save the status text, notice title, date retrieved, and any required next action. A screenshot without the source and date is weak evidence.' },
          { label: 'Compare', text: 'Use processing-time estimates only as a dynamic reference. They do not forecast an individual result or replace a notice.' },
      ...
      },
      {
        ...
        bullets: [
          ...
          'Use an individual account when the agency says the account is personal; do not share credentials as a team workaround.',
      ...
      },
      {
        ...
        heading: 'When a status page is not enough',
        paragraphs: [
          paragraph('Escalate when the question depends on a prior refusal, a status or travel consequence, a personal deadline, a missing or returned document, a changed address, a changed employer or role, a dependent, or any fact that the public status line does not show. The right escalation is the official agency contact path, school or sponsor owner, employer representative, or qualified attorney—not a stronger guess.', ['uscis-contact-center', 'state-nvc', 'cbp-admission']),
        ],
        note: 'Verify current portal links, contact routes, processing tools, and agency instructions before acting. USIVA is not a law firm and cannot interpret a private status record as a legal outcome.',
  ...
  },
  {
    ...
    deck: 'Good immigration research begins with definitions, release context, and source ownership. This brief gives readers a repeatable way to use DHS, Data.gov, USCIS, and State Department data without manufacturing a headline.',
    ...
    thesis: 'Define the event, unit, period, source, denominator, and caveat before reading a number. The official dataset or report remains the authority, and the catalog is not the same thing as the underlying data.',
    ...
    sections: [
      ...
      },
      {
        ...
        table: {
          caption: 'A source map for responsible starting points; no figures are reproduced here',
          ...
          rows: [
            ...
            ['USCIS Immigration and Citizenship Data', 'What does USCIS report about receipts, approvals, denials, pending cases, processing measures, or form-specific workload?', 'A USCIS case-performance table is not a population estimate and should not be treated as one.'],
            ...
            ['Data.gov and its catalog', 'Where is the publishing agency’s dataset metadata, access level, resource link, and contact?', 'Data.gov is a catalog and metadata layer; it does not own or necessarily host the underlying data file.'],
          ],
        },
      ...
      },
      {
        ...
        bullets: [
          ...
          'Issuance, admission, adjustment, approval, receipt, and pending: these are not interchangeable events or people counts.',
      ...
      },
      {
        ...
        steps: [
          { label: 'Question', text: 'Write the question as an observable event, not a conclusion: “How many reported issuances…?” or “What does this USCIS table measure?”' },
          ...
          { label: 'Limit', text: 'Record what the source cannot answer and what another official source would be needed to complete the picture.' },
          { label: 'Recheck', text: 'Before publication, reopen the live official page and confirm that the resource, definition, and release context have not changed.' },
        ],
        sourceIds: ['dhs-yearbook', 'uscis-data', 'state-visa-statistics', 'data-gov-catalog'],
      },
      {
        id: 'catalog-is-not-data',
        heading: 'A catalog record is not automatically a public data file',
        paragraphs: [
          paragraph('Data.gov describes itself as a metadata catalog: it points readers to datasets and their publishing agencies, but it does not own or manage the underlying data. A catalog record can also identify an access level, a contact, a resource URL, and a metadata update date that differ from the data’s own release date.', ['data-gov', 'data-gov-catalog']),
          paragraph('Use a Data.gov record to locate and document a source. Then follow the publishing agency’s resource and read its access, privacy, methodology, and license information. If the record is not public or the file cannot be verified, say so and do not fill the gap with an estimate.', ['data-gov-immigration-catalog', 'data-gov']),
        ],
        sourceIds: ['data-gov', 'data-gov-catalog', 'data-gov-immigration-catalog'],
      },
      {
        id: 'no-personal-forecast',
        heading: 'Do not turn aggregate data into a personal forecast',
        paragraphs: [
          paragraph('A published count can describe the source’s defined workload or event. It cannot, by itself, predict whether a particular person will receive a visa, be admitted, obtain a benefit, receive work authorization, or have a case decided by a certain date. Those questions depend on the person’s facts, category, record, current instructions, and responsible agency.', ['dhs-yearbook', 'uscis-data', 'state-visa-statistics', 'cbp-admission']),
          paragraph('This brief intentionally does not reproduce a headline statistic. It gives the reader a method for finding the current official table and preserving its limitations. Verify the live DHS, USCIS, State Department, and Data.gov pages before relying on a research result.', ['dhs-immigration-statistics', 'uscis-data', 'state-visa-statistics', 'data-gov']),
        ],
        note: 'USIVA is not a law firm and is not a statistical agency. For legal decisions, use the relevant official agency or qualified immigration counsel; for data questions, contact the publishing agency named in the official record.',
